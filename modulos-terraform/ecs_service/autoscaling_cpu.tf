...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  ...
  alarm_description = "Alarme quando a CPU estiver acima de ${var.scale_out_cpu_threshold}%"
  alarm_actions = [
...
resource "aws_cloudwatch_metric_alarm" "cpu_low" {
  ...
  alarm_description = "Alarme quando a CPU estiver abaixo de ${var.scale_in_cpu_threshold}%"
  alarm_actions = [
