module "ecs_service-app-01" {
  source = "../../../../arquitetura-de-containers-aws/modulos-terraform/ecs_service"
  ...
  service_task_execution_role = aws_iam_role.task_execution_role.arn
